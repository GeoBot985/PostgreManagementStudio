...
| Maintenance | DEFER_TO_LATER_RELEASE | DIAGNOSTIC_OR_TEMPORARY_UI | Routine database care | Maintenance service | medium | Fixed operation/target scope and lock duration | 15 |
