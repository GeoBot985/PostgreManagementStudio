...
public sealed record ObjectSearchResult(SearchObjectType ObjectType, string Database, string Schema, string ObjectName, string? ParentObject, string MatchType, string? MatchPreview);
